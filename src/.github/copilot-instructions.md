...
- Preserve the QuickSave navigation branch in RootPage.xaml.cs for UniversalSend; do not simplify it away even if it currently looks unreachable, because QuickSave is planned to be used later.